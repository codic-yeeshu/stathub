...
# Random suffix keeps the bucket name globally unique even when the
# stack is destroyed and recreated.
...
# Keep the registries from growing unbounded - hold the most recent 10
# tagged images and prune anything older or untagged after a day.
